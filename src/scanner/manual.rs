...
/// Scans `/opt`, user binaries in `~/.local/bin`, `~/Applications`, and detects AppImages.
pub async fn scan_manual_installations() -> Vec<Application> {
    tokio::task::spawn_blocking(|| {
                ...
                for entry in entries.flatten() {
                    ...
                    if path.is_dir() {
                        ...
                        if seen_paths.insert(path.clone()) {
                            ...
                            // Search for executable or launcher inside
        ...
        // 2. Scan standard AppImage and local bin locations
                    ...
                    if is_appimage {
                        if seen_paths.insert(path.to_path_buf()) {
                            ...
                            let mut app = Application::new(
                                format!("appimage-{}", clean_name.to_lowercase()),
                                &clean_name,
